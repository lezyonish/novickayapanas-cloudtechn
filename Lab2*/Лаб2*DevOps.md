...
контейнеры поднимаются в одном compose-проекте, но находятся в разных Docker-сетях, не могут резолвить имена друг друга, в нашем первом файле подобная реализация отсутствовала, однако мы это исправили.
